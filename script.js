const data = {
	...
	act_06: {
		pos: [
			...
			{ image: ['laba-image'], top: 103, left: 303, num: 0, name: 'Топь', desc: '<div>Область: <span class="lloca">Топь</span></div><div>Здесь находится Бог пантеона. Идём к нему сразу либо позже. (с ним шутки плохи, если у вас мало выживаемости).</div>' },
	...
	act_07: {
		pos: [
			...
			{ top: 168, left: 378, num: 6, name: 'Святилище Малигаро', desc: '<div>Область: <span class="lloca">Святилище Малигаро</span></div><div>У босса 3 стадии. Наносим 25% урона от его здоровья, он прячется и призывает питомца. В случае успешной победы с Малигаро выпадает <span class="quest">Чёрный яд</span> Отдаем яд "Шёлку", получаем в замен <span class="quest">Обсидиановый ключ</span></div>' },
	...
	act_09: {
		pos: [
			...
			{ image: ['point1-image'], top: 289, left: 711, num: 0, name: 'Оазис', desc: '<div>Область: <span class="lloca">Оазис</span></div><div>Добыв Клинок бури, отдаем его Петру и Иванне, и после беседы с Грехом забираем у Петра и Иванны<span class="quest">Закупоренную бурю</span> бежим вдоль стен до арены с босом. Убить "Шакари". 2 стадии. После потери трети здоровья прячется в песок, необходимо провести её до второй арены.</div>' },
	...
	act_10: {
		pos: [
			...
			{ top: 442, left: 582, num: 4, name: 'Осквернённая обитель', desc: '<div>Область: <span class="lloca">Оскверненная обитель</span></div><div>Убиваем боса и забираем <span class="quest">Посох Чистоты</span> Вернувшись в город отдаем эту палку "Бэннону", он превращается в успешную "Невинность".</div>' },
